...
import com.example.guru_start.Evaluate_DBManager.Companion.TABLE_NAME
import com.example.guru_start.databinding.ActivityMain1Binding
...
//  val ratingBar: RatingBar = findViewById(R.id.ratingBar)
    lateinit var dbManager: Evaluate_DBManager
...
//        EvaluateEditTextString = binding.EvaluateEditText.text.toString()// binding으로 EvaluateEditText 텍스트 받아오기
        ...
        //DBmanager객체 가져오기
        dbManager = Evaluate_DBManager(this, "강의평가3", null, 2)
