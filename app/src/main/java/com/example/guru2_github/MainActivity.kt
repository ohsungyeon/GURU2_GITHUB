...
import com.example.questionpage2.DBManager.Companion.COLUMN_STAR_RATING
import com.example.questionpage2.DBManager.Companion.TABLE_NAME
import com.example.questionpage2.databinding.ActivityMainBinding
...
//        setContentView(R.layout.activity_main)
        ...
        binding.spinner1.onItemSelectedListener = object: AdapterView.OnItemSelectedListener{
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                if(position != 0) Toast.makeText(this@MainActivity, itemList1[position], Toast.LENGTH_SHORT).show()
            }
        ...
        binding.spinner2.onItemSelectedListener = object: AdapterView.OnItemSelectedListener{
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                if(position != 0) Toast.makeText(this@MainActivity, itemList2[position], Toast.LENGTH_SHORT).show()
            }
            override fun onNothingSelected(parent: AdapterView<*>?) {
            }
        }
        ...
        binding.spinner3.onItemSelectedListener = object: AdapterView.OnItemSelectedListener{
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                if(position != 0) Toast.makeText(this@MainActivity, itemList3[position], Toast.LENGTH_SHORT).show()
            }
            override fun onNothingSelected(parent: AdapterView<*>?) {
            }
        }
        ...
        binding.spinner4.onItemSelectedListener = object: AdapterView.OnItemSelectedListener{
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                if(position != 0) Toast.makeText(this@MainActivity, itemList4[position], Toast.LENGTH_SHORT).show()
            }
            override fun onNothingSelected(parent: AdapterView<*>?) {
            }
        }
        ...
        binding.spinner5.onItemSelectedListener = object: AdapterView.OnItemSelectedListener{
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                if(position != 0) Toast.makeText(this@MainActivity, itemList5[position], Toast.LENGTH_SHORT).show()
            }
            override fun onNothingSelected(parent: AdapterView<*>?) {
            }
        }
        ...
        binding.spinner6.onItemSelectedListener = object: AdapterView.OnItemSelectedListener{
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                if(position != 0) Toast.makeText(this@MainActivity, itemList6[position], Toast.LENGTH_SHORT).show()
            }
            override fun onNothingSelected(parent: AdapterView<*>?) {
            }
        }
...
//        EvaluateEditTextString = binding.EvaluateEditText.text.toString()// binding으로 EvaluateEditText 텍스트 받아오기
        ...
        binding.storeButton.setOnClickListener {
            ...
            //다음 화면으로 넘기기
//            val intent = Intent(this, "다음화면 액티비티 이름"::class.java)
            //다음화면으로 넘기때 가져갈 정보(?)
